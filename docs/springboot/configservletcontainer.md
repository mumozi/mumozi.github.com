...
![](https://cdn.jsdelivr.net/gh/mumozi/Figure_bed/img/1574170320042.png)
...
![](https://cdn.jsdelivr.net/gh/mumozi/Figure_bed/img/1574172121748.png)

`WebServer`：嵌入式的web服务器实现

![](https://cdn.jsdelivr.net/gh/mumozi/Figure_bed/img/1574172310812.png)
...
![](https://cdn.jsdelivr.net/gh/mumozi/Figure_bed/img/1574235580031.png)
...
1. SpringBoot应用启动运行run方法
   ...
   ![](https://cdn.jsdelivr.net/gh/mumozi/Figure_bed/img/1574242390909.png)

2. 153行，创建IOC容器对象，根据当前环境创建

   ![](https://cdn.jsdelivr.net/gh/mumozi/Figure_bed/img/1574242209298.png)
...
4. 刷新IOC容器中272行，onRefresh()；web的ioc容器重写了onRefresh方法，查看`ServletWebServerApplicationContext`类的onRefresh方法，在方法中调用了this.createWebServer();方法创建web容器
   ...
   ![](https://cdn.jsdelivr.net/gh/mumozi/Figure_bed/img/1574243084120.png)
...
5. 在IDEA中可以这样配置
   ...
   ![](https://cdn.jsdelivr.net/gh/mumozi/Figure_bed/img/1574247311250.png)
...
6. WebApplicationInitializer的实现类
   ...
   ![](https://cdn.jsdelivr.net/gh/mumozi/Figure_bed/img/1574256076145.png)
