...
![](https://cdn.jsdelivr.net/gh/mumozi/Figure_bed/img/1573896827010.png)
...
1. 编写国际化配置文件，抽取页面需要显示的国际化消息
   ...
   ![](https://cdn.jsdelivr.net/gh/mumozi/Figure_bed/img/1573900332686.png)
...
4. 然后就可以更改浏览器语言，页面就会使用对应的国际化配置文件
      ...
      ![](https://cdn.jsdelivr.net/gh/mumozi/Figure_bed/img/1573900071209.png)
...
1. 点击删除提交发出delete请求
   ...
   ![](https://cdn.jsdelivr.net/gh/mumozi/Figure_bed/img/1573987255217.png)

   这个好像是2.0版本以后修改的

   ![](https://cdn.jsdelivr.net/gh/mumozi/Figure_bed/img/1573988088629.png)
